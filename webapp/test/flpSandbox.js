		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portal",
									"targetURL": "#simplotportals-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"simplotportals-display": {
								"semanticObject": "simplotportals",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=simplot.portals",
									"url": sap.ui.require.toUrl("simplot/portals")
								}
							}
						}
					}
